...
//    protected static Map<String, JsonObject> settingMap = new HashMap<String, JsonObject>(); 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		JsonObject configCred = Translate.settingMap.get(sessionId) == null?new JsonObject():Translate.settingMap.get(sessionId);
		if(username != null)
		...
		Translate.settingMap.put(sessionId, configCred);
